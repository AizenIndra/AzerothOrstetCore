...
void WorldSession::HandleCharFactionOrRaceChangeCallback(std::shared_ptr<CharacterFactionChangeInfo> factionChangeInfo, PreparedQueryResult result)
{
    ...
    if (oldRace != factionChangeInfo->Race)
    {
        ...
        if (factionChangeInfo->Race != RACE_ORC && factionChangeInfo->Race != RACE_HUMAN && factionChangeInfo->Race != RACE_WORGEN && factionChangeInfo->Race != RACE_GOBLIN && factionChangeInfo->Race != RACE_PANDAREN && factionChangeInfo->Race != RACE_VOIDELF && factionChangeInfo->Race != RACE_NIGHTBORNE && factionChangeInfo->Race != RACE_LIGHTFORGED && factionChangeInfo->Race != RACE_EREDAR && factionChangeInfo->Race != RACE_DRACTHYR && factionChangeInfo->Race != RACE_ZANDALARI_TROLL && factionChangeInfo->Race != RACE_OGRE && factionChangeInfo->Race != RACE_BROKEN && factionChangeInfo->Race != RACE_TUSKARR && factionChangeInfo->Race != RACE_FOREST_TROLL && factionChangeInfo->Race != RACE_PANDARENA && factionChangeInfo->Race != RACE_DEMONHUNTERH && factionChangeInfo->Race != RACE_ARAKKOA && factionChangeInfo->Race != RACE_DARKIRONDWARF && factionChangeInfo->Race != RACE_DRACTHYRA && factionChangeInfo->Race != RACE_KULTIRAN && factionChangeInfo->Race != RACE_DEMONHUNTERA)
        {
            stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_CHAR_SKILL_LANGUAGE);
            stmt->SetData(0, lowGuid);
