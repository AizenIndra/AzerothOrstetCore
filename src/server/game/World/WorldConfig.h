...
enum ServerConfigs
{
    ...
    CONFIG_ARENA_LEAVE_ANNOUNCER_ENABLE,
    ...
    CONFIG_ARENA_CAP_PER_DAYS,
    // Rank system - world buffs control
    CONFIG_RANK_BUFF_ENABLE_WORLD,
    CONFIG_RANK_BUFF_ALLOWED_ZONES,
    ...
    CONFIG_GUILD_LEVEL_REWARD_KILL_BOSS,
    CONFIG_GUILD_LEVEL_REWARD_ITEM_USE,
