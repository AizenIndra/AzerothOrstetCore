...
void sServerMenu::CharControlMenu(Player* player) {
    ...
    // AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, GetCustomText(player, RU_CHAR_CONTROL_7, EN_CHAR_CONTROL_7), GOSSIP_SENDER_MAIN + 1, 6); // Управление акков - отключено
